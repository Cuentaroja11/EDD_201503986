...
<body>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp; Pagina del Administrador de Naval Wars</div>
        <p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Pagina de Inicio" />
        </p>
        <p>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderStyle="Double" ForeColor="#0033CC" Height="494px" Width="766px">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button30" runat="server" OnClick="Button30_Click" Text="Tabla HASH" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
        </asp:Panel>
        <p>
        ...
        <p>
            &nbsp;</p>
        <asp:Panel ID="Panel2" runat="server" BorderStyle="Double" Height="600px" Width="766px">
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; Carga de Juegos:<br />
            <br />
            <br />
        ...
        <p>
            &nbsp;</p>
&nbsp;&nbsp;
        <asp:Panel ID="Panel8" runat="server" BorderStyle="Double" Height="537px" Width="766px">
            &nbsp;&nbsp;&nbsp;&nbsp;
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; Carga de contactos:<br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; Ubicacion:&nbsp;&nbsp;
            <asp:TextBox ID="TextBox36" runat="server" Width="556px"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button24" runat="server" OnClick="Button24_Click" Text="Cargar" />
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; Contenido del archivo:<br /> &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox37" runat="server" Height="223px" TextMode="MultiLine" Width="707px"></asp:TextBox>
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button25" runat="server" OnClick="Button25_Click" Text="Cargar" />
            <br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; Mostrar Arbol AVL de contactos del usuario:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox38" runat="server"></asp:TextBox>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button26" runat="server" OnClick="Button26_Click" Text="Mostrar" />
        </asp:Panel>
        <p>
            &nbsp;</p>
        <asp:Panel ID="Panel9" runat="server" BorderStyle="Double" Height="389px" Width="476px">
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; ABC de AVL de Contactos:<br />
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; Usuario Base:<br /> &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button27" runat="server" OnClick="Button27_Click" Text="Incertar" />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button28" runat="server" OnClick="Button28_Click" Text="Modificar" />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button29" runat="server" OnClick="Button29_Click" Text="Eliminar" />
        </asp:Panel>
        <p>
            &nbsp;</p>
        <p>

...
namespace EDDS2
{
    ...
    public class ListaJugadas
    {
        public class NodoLJ
        {
            public NodoLJ(String J1, String J2, int NJ, int AJ1, int AJ2, int EJ1, int EJ2, int TA, int TE)
            {
                this.Jugador1 = J1;
                this.Jugador2 = J2;
                this.NumeroJuego = NJ;
        ...
        public void Insertar(String J1, String J2, int NJ, int AJ1, int AJ2, int EJ1, int EJ2, int TA, int TE)
        {
            NodoLJ nuevo = new NodoLJ(J1, J2, NJ, AJ1, AJ2, EJ1, EJ2, TA, TE);
            if (primero == null)
            {
                primero = nuevo;
                ultimo = nuevo;
                ...
                while (salir == false)
                {
                    if (tmp != ultimo)
                    {
                        if (tmp.TotAtaques < tmp.Sig.TotAtaques)
                        {
                            ...
                            tmp.TotAtaques = tmp.Sig.TotAtaques;
                            tmp.TotElimina = tmp.Sig.TotElimina;
                            ...
                            tmp.Sig.TotAtaques = TA;
                            tmp.Sig.TotElimina = TE;
                ...
                while (salir == false)
                {
                    if (tmp.Sig != ultimo)
                    {
                        if (tmp.TotAtaques < tmp.Sig.TotAtaques)
                        {
                            ...
                            tmp.EliminadasJ1 = tmp.Sig.EliminadasJ1;
                            tmp.EliminadasJ2 = tmp.Sig.EliminadasJ2;
                            tmp.TotAtaques = tmp.Sig.TotElimina;

...
namespace EDDS
{
    public partial class PageAdministrador : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Image3.ImageUrl = "C:/Grafo/GrafoA.png";
            Image4.ImageUrl = "C:/Grafo/GrafoAESP.png";
        ...
        {
            String Contenido = TextBox11.Text;
        ...
        {
            String Contenido = TextBox29.Text;
            String Cont = Contenido;
            String[] st = new String[] { "," , "\n"};
            String[] Lineas = Cont.Split(st, StringSplitOptions.None);
        ...
        {
            String a = TextBox30.Text;
            String b = TextBox31.Text;
            int UDesp;
            int.TryParse(TextBox32.Text, out UDesp);
            int USob;
            int.TryParse(TextBox33.Text, out USob);
            int UDest;
            int.TryParse(TextBox34.Text, out UDest);
            int Gano;
            int.TryParse(TextBox35.Text, out Gano);
            Servicio.InsercionMasivaListasDelArbol(a, b, UDesp, USob, UDest, Gano);
            Servicio.Pintar();
            Servicio.CopiarImagenes(Server.MapPath("Imagenes/"));
            Image3.ImageUrl = "./Imagenes/GrafoA.png";
            Image4.ImageUrl = "./Imagenes/GrafoAESP.png";
        ...
        {
            StreamReader sr = new StreamReader(TextBox36.Text);
            String line;
            line = sr.ReadLine();
            String Contenido = "";
            int evitar = 0;
            ...
            foreach (string s in Lineas)
            {
                ...
                foreach (string v in Valores)
                {
                    ...
                    if (conteo == 4)
                    {
                        Servicio.InsercionMasivaAVLDelArbol(ub, op, pass, mail);
                        conteo = 0;
                    }
                }
            }
        ...
        {
            String Contenido = TextBox37.Text;
        ...
        {
            Servicio.PintarAVLDelArbol(TextBox38.Text);
        }

        protected void Button27_Click(object sender, EventArgs e)
        {
            Servicio.InsercionMasivaAVLDelArbol(TextBox39.Text, TextBox40.Text, TextBox41.Text, TextBox42.Text);
            Servicio.PintarAVLDelArbol(TextBox39.Text);
        }

        protected void Button28_Click(object sender, EventArgs e)
        {
            Servicio.ModificarEnAVLDelArbol(TextBox39.Text, TextBox40.Text, TextBox41.Text, TextBox42.Text);
            Servicio.PintarAVLDelArbol(TextBox39.Text);
        }

        protected void Button29_Click(object sender, EventArgs e)
        {
            Servicio.BorrarEnAVLDelArbol(TextBox39.Text, TextBox40.Text);
            Servicio.PintarAVLDelArbol(TextBox39.Text);
        }

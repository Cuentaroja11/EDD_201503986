...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="White" BorderStyle="Double" ForeColor="#0033CC" Height="437px" Width="766px">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br />
        ...
        <p>
            &nbsp;</p>
        <asp:Panel ID="Panel2" runat="server" BorderStyle="Double" Height="530px" Width="766px">
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp; Carga de Juegos:<br />
            <br />
            <br />
        ...
        <asp:Panel ID="Panel6" runat="server" BorderStyle="Double" Height="748px" Width="766px">
            <br />
